var RichText = React.createClass({displayName: "RichText",
    ...
    render: function () {
        ...
        return (
                React.createElement("span", null, 
                    text, 
                    moredata ? React.createElement("a", {href: "#", onClick: this.OnClickMoreDetails}, " ...read details...") : null
                )
        );
    }
});
    ...
    render: function () {
        return(
            React.createElement("div", null, 
                React.createElement("button", {onClick: this.openOverlayScreen}, " Show Graph "), 
                React.createElement("div", {className: "overlay", id: "overlayScreen"+this.props.id}, 
                    React.createElement("a", {href: "javascript:void(0)", className: "closebtn", onClick: this.closeOverlayScreen}, "×"), 
                    React.createElement("div", {className: "works rolefacet", id: this.props.id}
                    )
                )
            )
        );
...
var RetunToTopBtn =  React.createClass({displayName: "RetunToTopBtn",
   onClickHandle: function(){
    ...
    render : function () {
       return(
           React.createElement("a", {href: "javascript:", id: "return-to-top", title: "Return to top", onClick: this.onClickHandle}, React.createElement("i", {className: "fa fa-angle-double-up"}))
       )
   } 
});